...
const S = {
  ...
  "Plošné výkony (JBL na osobu a hodinu) platia pre všetky dni – používa ich Predikcia (hodiny na spracovanie), KPI aj backlog. Úpravy pre konkrétne dni sa spravujú v záložke KPI a majú pred plošnými prednosť.":
  ...
  "Vyber príjemcov (spravujú sa v záložke Výkony):": ["Vyber příjemce (spravují se v záložce Výkony):", "Choose recipients (managed in the Rates tab):", "Вибери одержувачів (керуються у вкладці «Продуктивність»):"],
  ...
  "Žiadni príjemcovia – pridaj ich v záložke Výkony.": ["Žádní příjemci – přidej je v záložce Výkony.", "No recipients – add them in the Rates tab.", "Немає одержувачів – додай їх у вкладці «Продуктивність»."],
  "Prehľad SKLC3": ["Přehled SKLC3", "SKLC3 overview", "Огляд SKLC3"],
  ...
  "PREDIKCIA SKLC3": ["PREDIKCE SKLC3", "SKLC3 FORECAST", "ПРОГНОЗ SKLC3"],
  ...
  "doplň výkony v záložke Výkony": ["doplň výkony v záložce Výkony", "add rates in the Rates tab", "додай норми у вкладці «Продуктивність»"],
